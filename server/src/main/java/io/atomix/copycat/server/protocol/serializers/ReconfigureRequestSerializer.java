...
public class ReconfigureRequestSerializer extends RaftProtocolRequestSerializer<ReconfigureRequest> {
  @Override
  public void writeObject(BufferOutput output, ReconfigureRequest request) {
  ...
  @Override
  public ReconfigureRequest readObject(BufferInput input, Class<ReconfigureRequest> type) {
