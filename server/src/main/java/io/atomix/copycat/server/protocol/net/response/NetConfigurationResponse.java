 ...
 */
public abstract class NetConfigurationResponse extends AbstractNetResponse implements ConfigurationResponse, RaftNetResponse {
  protected final long index;
  protected final long term;
  protected final long timestamp;
  protected final Collection<Member> members;

  public NetConfigurationResponse(long id, Status status, CopycatError error, long index, long term, long timestamp, Collection<Member> members) {
  ...
  public boolean equals(Object object) {
    if (getClass().isAssignableFrom(object.getClass())) {
      NetConfigurationResponse response = (NetConfigurationResponse) object;
   ...
   */
  public static abstract class Builder<T extends ConfigurationResponse.Builder<T, U>, U extends ConfigurationResponse> extends AbstractNetResponse.Builder<T, U> implements ConfigurationResponse.Builder<T, U> {
