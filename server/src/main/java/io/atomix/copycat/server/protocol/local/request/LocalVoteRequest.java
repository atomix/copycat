 ...
 */
public class LocalVoteRequest extends AbstractLocalRequest implements VoteRequest {
  private final long term;
  private final int candidate;
  private final long logIndex;
  private final long logTerm;

  public LocalVoteRequest(long term, int candidate, long logIndex, long logTerm) {
    this.term = term;
  ...
  public boolean equals(Object object) {
    if (object instanceof LocalVoteRequest) {
      LocalVoteRequest request = (LocalVoteRequest) object;
   ...
   */
  public static class Builder extends AbstractLocalRequest.Builder<VoteRequest.Builder, VoteRequest> implements VoteRequest.Builder {
    private long term = -1;
    ...
    @Override
    public LocalVoteRequest build() {
      return new LocalVoteRequest(term, candidate, logIndex, logTerm);
    }
  }
}
