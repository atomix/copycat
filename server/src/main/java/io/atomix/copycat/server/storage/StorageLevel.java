 ...
 * {@link io.atomix.copycat.util.buffer.Buffer} to which to write entries. See the specific storage levels for more
 * information.
 *
 * @see Storage
 *
...
public enum StorageLevel {
   ...
   * <p>
   * In-memory logs will be written to {@link Segment segments} backed by {@link io.atomix.copycat.util.buffer.HeapBuffer}.
   ...
   * <p>
   * Memory mapped logs will be written to {@link Segment segments} backed by {@link io.atomix.copycat.util.buffer.MappedBuffer}.
   ...
   * Stores logs on disk.
   * <p>
   * On-disk logs will be written to {@link Segment segments} backed by {@link io.atomix.copycat.util.buffer.FileBuffer}, which
