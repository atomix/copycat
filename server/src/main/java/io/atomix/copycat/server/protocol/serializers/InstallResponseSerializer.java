...
public class InstallResponseSerializer extends RaftProtocolResponseSerializer<InstallResponse> {
  @Override
  public void writeObject(BufferOutput output, InstallResponse response) {
