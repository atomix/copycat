 ...
 */
public class LocalJoinRequest extends LocalConfigurationRequest implements JoinRequest {
  public LocalJoinRequest(Member member) {
    super(member);
  }
   ...
   */
  public static class Builder extends LocalConfigurationRequest.Builder<JoinRequest.Builder, JoinRequest> implements JoinRequest.Builder {
    @Override
    public JoinRequest build() {
      return new LocalJoinRequest(member);
    }
  }
}
