...
public final class MajorCompactionManager implements CompactionManager {
  ...
  public List<CompactionTask> buildTasks(Storage storage, SegmentManager segments) {
    ...
    return !groups.isEmpty() ? Collections.singletonList(new MajorCompactionTask(segments, groups, compactor.snapshotIndex(), compactor.majorIndex(), compactor.defaultCompactionMode)) : Collections.emptyList();
  }
