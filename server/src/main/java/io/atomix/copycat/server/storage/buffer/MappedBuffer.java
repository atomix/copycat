...
import io.atomix.copycat.server.storage.buffer.util.MappedMemory;
import io.atomix.copycat.server.storage.buffer.util.MappedMemoryAllocator;
import io.atomix.copycat.server.storage.buffer.util.Memory;
...
public class MappedBuffer extends NativeBuffer {
   ...
   *
   * @see MappedBuffer#allocate(File, FileChannel.MapMode)
   * @see MappedBuffer#allocate(File, long)
   * @see MappedBuffer#allocate(File, FileChannel.MapMode, long)
   * @see MappedBuffer#allocate(File, long, long)
   * @see MappedBuffer#allocate(File, FileChannel.MapMode, long, long)
   */
   ...
   * @throws NullPointerException If {@code file} is {@code null}
   *
   * @see MappedBuffer#allocate(File)
   * @see MappedBuffer#allocate(File, long)
   * @see MappedBuffer#allocate(File, FileChannel.MapMode, long)
   * @see MappedBuffer#allocate(File, long, long)
   * @see MappedBuffer#allocate(File, FileChannel.MapMode, long, long)
