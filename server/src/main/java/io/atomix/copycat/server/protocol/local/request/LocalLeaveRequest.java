 ...
 */
public class LocalLeaveRequest extends LocalConfigurationRequest implements LeaveRequest {
  public LocalLeaveRequest(Member member) {
    super(member);
  }
   ...
   */
  public static class Builder extends LocalConfigurationRequest.Builder<LeaveRequest.Builder, LeaveRequest> implements LeaveRequest.Builder {
    @Override
    public LocalLeaveRequest build() {
      return new LocalLeaveRequest(member);
    }
  }
}
