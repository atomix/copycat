 ...
 */
package io.atomix.copycat.server.storage.buffer.util;

/**
 * Memory allocator.
 * <p>
 * Memory allocators handle allocation of memory for {@link io.atomix.copycat.server.storage.buffer.Bytes}
 * objects, providing descriptors that point to memory addresses.
 *
