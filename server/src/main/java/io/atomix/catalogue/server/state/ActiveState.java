...
import io.atomix.catalogue.client.error.RaftError;
import io.atomix.catalogue.client.error.RaftException;
import io.atomix.catalogue.client.request.CommandRequest;
import io.atomix.catalogue.client.request.QueryRequest;
import io.atomix.catalogue.client.request.Request;
import io.atomix.catalogue.client.response.CommandResponse;
import io.atomix.catalogue.client.response.QueryResponse;
import io.atomix.catalogue.client.response.Response;
import io.atomix.catalogue.server.RaftServer;
import io.atomix.catalogue.server.request.AppendRequest;
import io.atomix.catalogue.server.request.PollRequest;
import io.atomix.catalogue.server.request.VoteRequest;
import io.atomix.catalogue.server.response.AppendResponse;
import io.atomix.catalogue.server.response.PollResponse;
import io.atomix.catalogue.server.response.VoteResponse;
import io.atomix.catalogue.server.storage.entry.Entry;
import io.atomix.catalogue.server.storage.entry.QueryEntry;
