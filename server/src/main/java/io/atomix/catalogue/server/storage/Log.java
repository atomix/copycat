 ...
 */
package io.atomix.catalogue.server.storage;

import io.atomix.catalogue.server.storage.cleaner.Cleaner;
import io.atomix.catalogue.server.storage.entry.Entry;
import io.atomix.catalogue.server.storage.entry.TypedEntryPool;
...
public class Log implements AutoCloseable {
  ...
  protected Log(String name, Storage storage) {
    ...
    this.cleaner = new Cleaner(segments, Executors.newScheduledThreadPool(storage.cleanerThreads(), new CatalystThreadFactory("catalogue-cleaner-%d")));
  }
