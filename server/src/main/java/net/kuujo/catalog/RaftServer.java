...
import net.kuujo.catalog.state.ServerContext;
import net.kuujo.catalog.storage.Storage;
...
public class RaftServer implements Managed<RaftServer> {
   ...
   * <p>
   * The {@link net.kuujo.catalyst.util.concurrent.Context} can also be used to access the Raft server's internal
   ...
   * Raft server builder.
   */
  public static class Builder extends net.kuujo.catalyst.util.Builder<RaftServer> {
