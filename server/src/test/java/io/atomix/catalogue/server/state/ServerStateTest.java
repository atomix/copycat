...
import io.atomix.catalogue.server.state.ConnectionManager;
import io.atomix.catalogue.server.state.ServerState;
import io.atomix.catalogue.server.storage.Log;
import io.atomix.catalogue.server.storage.Storage;
import io.atomix.catalogue.server.storage.StorageLevel;
...
public class ServerStateTest extends ConcurrentTestCase {
   ...
   */
  private void transition(RaftServer.State state) throws Throwable {
    context.execute(() -> {
