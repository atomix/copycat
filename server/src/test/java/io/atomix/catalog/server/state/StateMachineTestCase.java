...
import io.atomix.catalog.server.storage.entry.CommandEntry;
import io.atomix.catalog.server.storage.entry.KeepAliveEntry;
import io.atomix.catalog.server.storage.entry.QueryEntry;
import io.atomix.catalog.server.storage.entry.RegisterEntry;
