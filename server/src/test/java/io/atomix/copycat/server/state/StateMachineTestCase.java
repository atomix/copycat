...
public abstract class StateMachineTestCase extends ConcurrentTestCase {
  ...
  public void setupStateMachine() {
    ...
    stateMachine = new ServerStateMachine(createStateMachine(), log, new ServerStateMachineContext(new ConnectionManager(transport.client()), new ServerSessionManager()), stateContext);
  }
