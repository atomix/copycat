...
public abstract class StateMachineTestCase extends ConcurrentTestCase {
  ...
  public void setupStateMachine() {
    ...
    stateMachine = new ServerStateMachine(createStateMachine(), new ServerStateMachineContext(new ConnectionManager(transport.client()), new ServerSessionManager()), log, stateContext);
  }
