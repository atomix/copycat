 ...
 * {@link io.atomix.copycat.client.request.CommandRequest}. Command responses are sent with the
 * {@link #version()} (or index) of the state machine at the point at which the command was evaluated.
