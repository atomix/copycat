 ...
 */
public class LocalQueryRequest extends LocalOperationRequest implements QueryRequest {
  private final long index;
  private final Query query;

  protected LocalQueryRequest(long session, long sequence, long index, Query query) {
  ...
  public boolean equals(Object object) {
    if (object instanceof LocalQueryRequest) {
      LocalQueryRequest request = (LocalQueryRequest) object;
   ...
   */
  public static class Builder extends LocalOperationRequest.Builder<QueryRequest.Builder, QueryRequest> implements QueryRequest.Builder {
    private long index;
    private Query query;
    ...
    public QueryRequest build() {
      return new LocalQueryRequest(session, sequence, index, query);
    }
  }
}
