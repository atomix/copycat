 ...
 */
public class LocalKeepAliveResponse extends LocalSessionResponse implements KeepAliveResponse {
  private final Address leader;
  private final Collection<Address> members;

  protected LocalKeepAliveResponse(Status status, CopycatError error, Address leader, Collection<Address> members) {
    super(status, error);
    this.leader = leader;
  ...
  public boolean equals(Object object) {
    if (object instanceof LocalKeepAliveResponse) {
      LocalKeepAliveResponse response = (LocalKeepAliveResponse) object;
   ...
   */
  public static class Builder extends LocalSessionResponse.Builder<KeepAliveResponse.Builder, KeepAliveResponse> implements KeepAliveResponse.Builder {
    ...
    public KeepAliveResponse build() {
      return new LocalKeepAliveResponse(status, error, leader, members);
    }
  }
}
