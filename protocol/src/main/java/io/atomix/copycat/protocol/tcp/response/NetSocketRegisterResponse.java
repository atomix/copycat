 ...
 */
public class NetSocketRegisterResponse extends AbstractNetSocketResponse implements RegisterResponse {
  private final long session;
  private final Address leader;
  private final Collection<Address> members;
  private final long timeout;

  protected NetSocketRegisterResponse(long id, Status status, CopycatError error, long session, Address leader, Collection<Address> members, long timeout) {
  ...
  public boolean equals(Object object) {
    if (object instanceof NetSocketRegisterResponse) {
      NetSocketRegisterResponse response = (NetSocketRegisterResponse) object;
   ...
   */
  public static class Builder extends AbstractNetSocketResponse.Builder<RegisterResponse.Builder, RegisterResponse> implements RegisterResponse.Builder {
    ...
    public RegisterResponse build() {
      return new NetSocketRegisterResponse(id, status, error, session, leader, members, timeout);
    }
  }
   ...
   */
  public static class Serializer extends AbstractNetSocketResponse.Serializer<NetSocketRegisterResponse> {
    @Override
    public void write(Kryo kryo, Output output, NetSocketRegisterResponse response) {
    ...
    public NetSocketRegisterResponse read(Kryo kryo, Input input, Class<NetSocketRegisterResponse> type) {
      return new NetSocketRegisterResponse(input.readLong(), Status.forId(input.readByte()), CopycatError.forId(input.readByte()), input.readLong(), kryo.readObject(input, Address.class), kryo.readObject(input, Collection.class), input.readLong());
    }
  }
}
