 ...
 */
public abstract class AbstractNetResponse implements NetResponse {
  @JsonProperty("id")
  ...
  protected AbstractNetResponse(long id, Status status, CopycatError error) {
    this.id = id;
    this.status = status;
    this.error = error;
  }
   ...
   */
  public static abstract class Serializer<T extends AbstractNetResponse> extends com.esotericsoftware.kryo.Serializer<T> {
  }
}
