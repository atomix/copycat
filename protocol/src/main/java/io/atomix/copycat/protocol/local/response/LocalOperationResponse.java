 ...
 */
public abstract class LocalOperationResponse extends LocalSessionResponse implements OperationResponse {
  protected final long index;
  protected final long eventIndex;
  protected final Object result;

  protected LocalOperationResponse(Status status, CopycatError error, long index, long eventIndex, Object result) {
    super(status, error);
    this.index = index;
  ...
  public boolean equals(Object object) {
    if (getClass().isAssignableFrom(object.getClass())) {
      LocalOperationResponse response = (LocalOperationResponse) object;
   ...
   */
  public static abstract class Builder<T extends OperationResponse.Builder<T, U>, U extends OperationResponse> extends LocalSessionResponse.Builder<T, U> implements OperationResponse.Builder<T, U> {
