 ...
 */
public abstract class WebSocketOperationRequest extends WebSocketSessionRequest implements OperationRequest {
  @JsonProperty("sequence")
  protected final long sequence;

  protected WebSocketOperationRequest(long id, long session, long sequence) {
    super(id, session);
   ...
   */
  public static abstract class Builder<T extends OperationRequest.Builder<T, U>, U extends OperationRequest> extends WebSocketSessionRequest.Builder<T, U> implements OperationRequest.Builder<T, U> {
