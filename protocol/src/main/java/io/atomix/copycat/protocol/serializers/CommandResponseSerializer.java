...
public class CommandResponseSerializer extends ProtocolResponseSerializer<CommandResponse> {
  @Override
  public void writeObject(BufferOutput output, CommandResponse response) {
  ...
  @Override
  public CommandResponse readObject(BufferInput input, Class<CommandResponse> type) {
