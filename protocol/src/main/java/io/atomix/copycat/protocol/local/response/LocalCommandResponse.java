 ...
 */
public class LocalCommandResponse extends LocalOperationResponse implements CommandResponse {
  protected LocalCommandResponse(Status status, CopycatError error, long index, long eventIndex, Object result) {
   ...
   */
  public static class Builder extends LocalOperationResponse.Builder<CommandResponse.Builder, CommandResponse> implements CommandResponse.Builder {
    @Override
    public CommandResponse build() {
      return new LocalCommandResponse(status, error, index, eventIndex, result);
    }
  }
}
