 ...
 */
public class NetSocketKeepAliveResponse extends NetSocketSessionResponse implements KeepAliveResponse {
  private final Address leader;
  private final Collection<Address> members;

  protected NetSocketKeepAliveResponse(long id, Status status, CopycatError error, Address leader, Collection<Address> members) {
  ...
  public boolean equals(Object object) {
    if (object instanceof NetSocketKeepAliveResponse) {
      NetSocketKeepAliveResponse response = (NetSocketKeepAliveResponse) object;
   ...
   */
  public static class Builder extends NetSocketSessionResponse.Builder<KeepAliveResponse.Builder, KeepAliveResponse> implements KeepAliveResponse.Builder {
    ...
    public KeepAliveResponse build() {
      return new NetSocketKeepAliveResponse(id, status, error, leader, members);
    }
  }
   ...
   */
  public static class Serializer extends NetSocketSessionResponse.Serializer<NetSocketKeepAliveResponse> {
    @Override
    public void write(Kryo kryo, Output output, NetSocketKeepAliveResponse response) {
    ...
    public NetSocketKeepAliveResponse read(Kryo kryo, Input input, Class<NetSocketKeepAliveResponse> type) {
      return new NetSocketKeepAliveResponse(input.readLong(), Status.forId(input.readByte()), CopycatError.forId(input.readByte()), kryo.readObject(input, Address.class), kryo.readObject(input, Collection.class));
    }
  }
}
