 ...
 */
public class NetSocketConnectResponse extends AbstractNetSocketResponse implements ConnectResponse {
  private final Address leader;
  private final Collection<Address> members;

  protected NetSocketConnectResponse(long id, Status status, CopycatError error, Address leader, Collection<Address> members) {
  ...
  public boolean equals(Object object) {
    if (object instanceof NetSocketConnectResponse) {
      NetSocketConnectResponse response = (NetSocketConnectResponse) object;
   ...
   */
  public static class Builder extends AbstractNetSocketResponse.Builder<ConnectResponse.Builder, ConnectResponse> implements ConnectResponse.Builder {
    ...
    public ConnectResponse build() {
      return new NetSocketConnectResponse(id, status, error, leader, members);
    }
  }
   ...
   */
  public static class Serializer extends AbstractNetSocketResponse.Serializer<NetSocketConnectResponse> {
    @Override
    public void write(Kryo kryo, Output output, NetSocketConnectResponse response) {
    ...
    @Override
    public NetSocketConnectResponse read(Kryo kryo, Input input, Class<NetSocketConnectResponse> type) {
      return new NetSocketConnectResponse(input.readLong(), Status.forId(input.readByte()), CopycatError.forId(input.readByte()), kryo.readObject(input, Address.class), kryo.readObject(input, Collection.class));
    }
  }
}
