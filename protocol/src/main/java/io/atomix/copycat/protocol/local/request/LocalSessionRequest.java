 ...
 */
public abstract class LocalSessionRequest extends AbstractLocalRequest implements SessionRequest {
  protected final long session;

  protected LocalSessionRequest(long session) {
   ...
   */
  public static abstract class Builder<T extends SessionRequest.Builder<T, U>, U extends SessionRequest> extends AbstractLocalRequest.Builder<T, U> implements SessionRequest.Builder<T, U> {
