 ...
 */
public abstract class NetOperationRequest extends NetSessionRequest implements OperationRequest {
  protected final long sequence;

  protected NetOperationRequest(long id, long session, long sequence) {
    super(id, session);
   ...
   */
  public static abstract class Builder<T extends OperationRequest.Builder<T, U>, U extends OperationRequest> extends NetSessionRequest.Builder<T, U> implements OperationRequest.Builder<T, U> {
   ...
   */
  public static abstract class Serializer<T extends NetOperationRequest> extends NetSessionRequest.Serializer<T> {
  }
}
