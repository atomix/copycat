 ...
 */
public abstract class NetOperationResponse extends NetSessionResponse implements OperationResponse {
  protected final long index;
  protected final long eventIndex;
  protected final Object result;

  protected NetOperationResponse(long id, Status status, CopycatError error, long index, long eventIndex, Object result) {
  ...
  public boolean equals(Object object) {
    if (getClass().isAssignableFrom(object.getClass())) {
      NetOperationResponse response = (NetOperationResponse) object;
   ...
   */
  public static abstract class Builder<T extends OperationResponse.Builder<T, U>, U extends OperationResponse> extends NetSessionResponse.Builder<T, U> implements OperationResponse.Builder<T, U> {
   ...
   */
  public static abstract class Serializer<T extends NetOperationResponse> extends NetSessionResponse.Serializer<T> {
  }
}
