 ...
 */
public abstract class LocalOperationRequest extends LocalSessionRequest implements OperationRequest {
  protected final long sequence;

  protected LocalOperationRequest(long session, long sequence) {
    super(session);
   ...
   */
  public static abstract class Builder<T extends OperationRequest.Builder<T, U>, U extends OperationRequest> extends LocalSessionRequest.Builder<T, U> implements OperationRequest.Builder<T, U> {
