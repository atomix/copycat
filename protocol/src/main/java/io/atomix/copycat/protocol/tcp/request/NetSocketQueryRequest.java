 ...
 */
public class NetSocketQueryRequest extends NetSocketOperationRequest implements QueryRequest {
  private final long index;
  private final Query query;

  protected NetSocketQueryRequest(long id, long session, long sequence, long index, Query query) {
  ...
  public boolean equals(Object object) {
    if (object instanceof NetSocketQueryRequest) {
      NetSocketQueryRequest request = (NetSocketQueryRequest) object;
   ...
   */
  public static class Builder extends NetSocketOperationRequest.Builder<QueryRequest.Builder, QueryRequest> implements QueryRequest.Builder {
    private long index;
    private Query query;
    ...
    public QueryRequest build() {
      return new NetSocketQueryRequest(id, session, sequence, index, query);
    }
  }
   ...
   */
  public static class Serializer extends NetSocketOperationRequest.Serializer<NetSocketQueryRequest> {
    @Override
    public void write(Kryo kryo, Output output, NetSocketQueryRequest request) {
    ...
    @Override
    public NetSocketQueryRequest read(Kryo kryo, Input input, Class<NetSocketQueryRequest> type) {
      return new NetSocketQueryRequest(input.readLong(), input.readLong(), input.readLong(), input.readLong(), (Query) kryo.readClassAndObject(input));
    }
  }
}
