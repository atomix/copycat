 ...
 */
public class LocalUnregisterResponse extends LocalSessionResponse implements UnregisterResponse {
  protected LocalUnregisterResponse(Status status, CopycatError error) {
    super(status, error);
  }
  ...
  public boolean equals(Object object) {
    if (object instanceof LocalUnregisterResponse) {
      LocalUnregisterResponse response = (LocalUnregisterResponse) object;
   ...
   */
  public static class Builder extends LocalSessionResponse.Builder<UnregisterResponse.Builder, UnregisterResponse> implements UnregisterResponse.Builder {
    @Override
    public UnregisterResponse build() {
      return new LocalUnregisterResponse(status, error);
    }
  }
}
