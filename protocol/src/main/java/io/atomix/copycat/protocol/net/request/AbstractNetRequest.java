...
public abstract class AbstractNetRequest implements NetRequest {
  ...
  protected AbstractNetRequest(long id) {
    this.id = id;
  }
   ...
   * Request serializer.
   */
  public static abstract class Serializer<T extends AbstractNetRequest> extends com.esotericsoftware.kryo.Serializer<T> {
  }
}
