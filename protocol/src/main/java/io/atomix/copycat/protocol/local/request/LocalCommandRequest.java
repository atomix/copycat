 ...
 */
public class LocalCommandRequest extends LocalOperationRequest implements CommandRequest {
  private final Command command;

  protected LocalCommandRequest(long session, long sequence, Command command) {
  ...
  public boolean equals(Object object) {
    if (object instanceof LocalCommandRequest) {
      LocalCommandRequest request = (LocalCommandRequest) object;
   ...
   */
  public static class Builder extends LocalOperationRequest.Builder<CommandRequest.Builder, CommandRequest> implements CommandRequest.Builder {
    ...
    public CommandRequest build() {
      return new LocalCommandRequest(session, sequence, command);
    }
  }
}
