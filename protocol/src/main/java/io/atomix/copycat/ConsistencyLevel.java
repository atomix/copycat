...
public enum ConsistencyLevel {
  ...
  ConsistencyLevel(int id) {
    this.id = id;
  }

  /**
   * Returns the consistency level for the given ID.
   *
   * @param id The consistency level ID.
   * @return The consistency level for the given ID.
   */
  public static ConsistencyLevel forId(int id) {
    switch (id) {
      case 1:
        return SEQUENTIAL;
      case 2:
      ...
      case 3:
        return LINEARIZABLE;
      default:
        throw new IllegalArgumentException("unknown consistency level: " + id);
    }
  }
}
