 ...
 */
public class UnknownStateMachineException extends CopycatException {
  private static final CopycatError.Type TYPE = CopycatError.Type.UNKNOWN_STATE_MACHINE_ERROR;
