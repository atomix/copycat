...
public class RaftClient implements Managed<RaftClient> {
   ...
   * query's {@link io.atomix.catalogue.client.Query.ConsistencyLevel}. For {@link io.atomix.catalogue.client.Query.ConsistencyLevel#LINEARIZABLE}
   * and {@link io.atomix.catalogue.client.Query.ConsistencyLevel#BOUNDED_LINEARIZABLE} consistency levels, queries will be forwarded
