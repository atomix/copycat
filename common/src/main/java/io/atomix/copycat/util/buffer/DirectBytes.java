...
import io.atomix.copycat.util.buffer.util.DirectMemory;
...
public class DirectBytes extends NativeBytes {
   ...
   * <p>
   * When the array is constructed, {@link io.atomix.copycat.util.buffer.util.DirectMemoryAllocator} will be used to allocate
