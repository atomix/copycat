...
import io.atomix.copycat.util.buffer.util.HeapMemory;
...
public class HeapBytes extends AbstractBytes {
   ...
   * <p>
   * When the array is constructed, {@link io.atomix.copycat.util.buffer.util.HeapMemoryAllocator} will be used to allocate
